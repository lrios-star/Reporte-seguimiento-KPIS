...
# =========================================================================
# Logo helper (cargado una vez en módulo level)
# =========================================================================
def _load_logo_b64() -> str:
    """Retorna el logo LOGO.png codificado en base64, o cadena vacía si no existe."""
...
def main():
    ...
    # HEADER
    # ================================================================
    render_header(current_label, previous_label, logo_b64=_LOGO_B64)
